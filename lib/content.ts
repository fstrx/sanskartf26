...
export const conflictCases: ConflictCase[] = [
  {
    ...
    mapX: 21,
    mapY: 48,
    summary: 'CFR tracks governance stress, insecurity, migration pressure, and organized crime across the Northern Triangle.',
    humanitarianNote: 'Communities face violence, extortion, weak services, and displacement pressure.',
    repairLesson: 'Stability depends on accountable institutions, economic opportunity, and community safety.',
  ...
  },
  {
    ...
    mapX: 29,
    mapY: 52,
    summary: 'CFR identifies criminal violence and political breakdown in Haiti as a worsening conflict concern.',
  ...
  },
  {
    ...
    mapX: 47,
    mapY: 51,
    summary: 'CFR tracks transnational extremist violence and state fragility across the central Sahel.',
  ...
  },
  {
    ...
    mapX: 78,
    mapY: 43,
    summary: 'CFR lists a Taiwan confrontation as an interstate crisis with critical implications for U.S. interests.',
    humanitarianNote: 'Escalation would place civilians, trade routes, and regional security under acute pressure.',
    repairLesson: 'Prevention depends on crisis communication, restraint, and credible deterrence without miscalculation.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 56,
    mapY: 58,
    summary: 'CFR tracks political instability and armed conflict risks in Ethiopia.',
    humanitarianNote: 'Communities remain exposed to displacement, insecurity, and contested political settlement.',
    repairLesson: 'Repair requires inclusive governance, local security, and accountability for abuses.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 60,
    mapY: 43,
    summary: 'CFR identifies direct confrontation involving Iran, Israel, and the United States as a critical interstate risk.',
    humanitarianNote: 'Escalation could widen regional harm and threaten civilian infrastructure across multiple countries.',
    repairLesson: 'Risk reduction depends on de-escalation channels, nuclear diplomacy, and regional security guarantees.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 25,
    mapY: 56,
    summary: 'CFR tracks confrontation between the United States and Venezuela as an interstate crisis with critical stakes.',
    humanitarianNote: 'Political pressure, economic fragility, migration, and security risks affect civilians across the region.',
    repairLesson: 'Durable stability needs credible negotiation, institutional guarantees, and humanitarian space.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 58,
    mapY: 55,
    summary: 'CFR tracks Yemen and Red Sea violence as a transnational terrorism and regional security concern.',
  ...
  },
  {
    ...
    mapX: 66,
    mapY: 45,
    summary: 'CFR tracks India-Pakistan tensions as an interstate conflict with significant implications.',
    humanitarianNote: 'Border communities face periodic insecurity while escalation risks affect the wider region.',
    repairLesson: 'Hotline discipline, tradeoffs around Kashmir, and sustained diplomacy reduce crisis risk.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 51,
    mapY: 47,
    summary: 'CFR tracks Libya as a civil war and fragmented-governance conflict.',
    humanitarianNote: 'Militia rule, displacement, detention abuses, and fragile services remain serious concerns.',
    repairLesson: 'Repair depends on unified institutions, demobilization, and accountable resource governance.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 57,
    mapY: 61,
    summary: 'CFR tracks the conflict with al-Shabaab as a transnational terrorism concern.',
    humanitarianNote: 'Civilians face attacks, displacement, drought pressure, and contested local governance.',
    repairLesson: 'Security operations need to pair with local legitimacy and reliable basic services.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 55,
    mapY: 46,
    summary: 'CFR tracks the Israeli-Palestinian conflict as a territorial dispute with significant U.S. interests.',
  ...
  },
  {
    ...
    mapX: 18,
    mapY: 45,
    summary: 'CFR tracks criminal violence in Mexico as a worsening security concern.',
    humanitarianNote: 'Violence affects families, journalists, officials, migrants, and local economies.',
    repairLesson: 'Reducing violence requires rule of law, anti-corruption capacity, and community protection.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 56,
    mapY: 40,
    summary: 'CFR tracks Turkey’s conflict with armed Kurdish groups as a territorial dispute.',
    humanitarianNote: 'Cross-border operations and political repression can affect civilians and displaced communities.',
    repairLesson: 'Political inclusion and local security guarantees are essential to de-escalation.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 58,
    mapY: 43,
    summary: 'CFR tracks political instability in Iraq as a worsening conflict concern.',
    humanitarianNote: 'Militia competition, governance gaps, and regional pressure shape civilian risk.',
    repairLesson: 'Stability depends on accountable institutions, service delivery, and restraint by armed actors.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 54,
    mapY: 58,
    summary: 'CFR tracks South Sudan as a worsening political instability case.',
    humanitarianNote: 'Food insecurity, displacement, and local violence continue to endanger civilians.',
    repairLesson: 'Peace implementation must reach local security, power sharing, and justice for communities.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 56,
    mapY: 35,
    summary: 'CFR tracks the war in Ukraine as an interstate conflict with critical U.S. interests.',
  ...
  },
  {
    ...
    mapX: 79,
    mapY: 39,
    summary: 'CFR tracks the North Korea crisis as an interstate conflict risk with critical U.S. interests.',
    humanitarianNote: 'Military escalation would place civilians across Northeast Asia at severe risk.',
    repairLesson: 'Crisis management depends on deterrence, communication channels, and nuclear risk reduction.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 72,
    mapY: 53,
    summary: 'CFR tracks Myanmar as a civil war with widespread armed resistance and military violence.',
  ...
  },
  {
    ...
    mapX: 75,
    mapY: 55,
    summary: 'CFR tracks South China Sea disputes as a territorial dispute with critical U.S. interests.',
    humanitarianNote: 'Escalation could affect coastal communities, shipping routes, and regional military stability.',
    repairLesson: 'Repair requires maritime rules, crisis channels, and respect for lawful access.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 52,
    mapY: 65,
    summary: 'CFR tracks conflict in the Democratic Republic of Congo as a worsening political instability case.',
  ...
  },
  {
    ...
    mapX: 52,
    mapY: 58,
    summary: 'CFR tracks conflict in the Central African Republic as a civil war.',
    humanitarianNote: 'Communities face armed group control, displacement, and weak public services.',
    repairLesson: 'Repair depends on local protection, credible governance, and accountable security forces.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 56,
    mapY: 44,
    summary: 'CFR tracks conflict with Hezbollah in Lebanon as a worsening interstate concern.',
    humanitarianNote: 'Border communities, displaced families, and fragile state services remain at risk.',
    repairLesson: 'De-escalation requires border security, political restraint, and civilian protection.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 57,
    mapY: 43,
    summary: 'CFR tracks Syria as a political instability conflict after years of civil war and foreign intervention.',
    humanitarianNote: 'Displacement, detention, reconstruction gaps, and fragmented authority continue to shape harm.',
    repairLesson: 'Repair requires rights protections, safe returns, and accountable local governance.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 63,
    mapY: 44,
    summary: 'CFR tracks instability in Afghanistan as a worsening political instability concern.',
    humanitarianNote: 'Economic collapse, rights restrictions, insecurity, and aid dependency affect daily life.',
    repairLesson: 'Repair needs humanitarian access, rights protections, and pathways for civic participation.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 65,
    mapY: 46,
    summary: 'CFR tracks instability in Pakistan as a worsening transnational terrorism concern.',
    humanitarianNote: 'Militant violence and political instability affect civilians and regional security.',
    repairLesson: 'Resilience depends on civilian governance, regional de-escalation, and local trust in institutions.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
    ...
    mapX: 58,
    mapY: 39,
    summary: 'CFR tracks Armenia-Azerbaijan tensions as a territorial dispute with improving but unresolved dynamics.',
    humanitarianNote: 'Displacement, border insecurity, and political mistrust remain central concerns.',
    repairLesson: 'Repair requires border guarantees, rights protections, and regional economic normalization.',
    sources: cfrConflictSources,
    lastReviewed: 'April 23, 2026',
  },
  {
